  ...
  return new SubscriptionClient(
    ...
    class MyWebSocket extends WebSocket {
      public constructor(url: string, protocols?: string | string[]) {
        ...
        super.addListener('open', (): void => {
          console.log('[GraphQL socket] on open')
        })
        super.addListener('ping', (): void => {
          console.log('[GraphQL socket] on "ping"')
        })
        super.addListener('pong', (): void => {
          console.log('[GraphQL socket] on "pong"')
        })
        super.addListener('message', (data: WebSocket.Data): void => {
          console.log('[GraphQL socket] on message: ', data)
        })
        super.addListener('close', (code: number, message: string): void => {
          console.log('[GraphQL socket] on close: ', code, message)
        })
        super.addListener('error', (err: Error): void => {
